...
const TimeRangeSelector = ({
  ...
  console.log('🔍 TimeRangeSelector 렌더링 - startTime:', startTime, 'endTime:', endTime);
  
  const formatTimeDisplay = (time: string) => {
    console.log('🔍 formatTimeDisplay 호출됨 - time:', time);
    
    if (!time || time === '오전 00:00') {
      console.log('🔍 기본값 표시 (오전 00:00)');
      return (
        <>

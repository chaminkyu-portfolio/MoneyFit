...
![image.png](attachment:fb668ed9-db6b-444b-9e01-4c234e48f8fd:image.png)
그럼 다음과 같이 1개의 예약에 3명의 인원이 예약하기가 된다 


![image.png](attachment:0e207994-6aaa-47d1-b667-17826dfb9301:image.png)
...
![image.png](attachment:eb0c8c5d-a33d-4ed6-890a-3a4a9c94ef8c:image.png)

해당 테이블의 동일한 값을 추가할 수 없게 된다

redis를 사용한 이유는 속도측면에서도 빠르고 Scale-out시에도 활용할 수 있기 때문에 사용했다

![image.png](attachment:08d6983d-ecaa-4366-89b0-29f8f38dcce9:image.png)

이로서 동시성 제어를 통해 1개의 데이터만 저장되게 된다

![image.png](attachment:f85ae8db-c0c0-40d0-9c5b-61f97f777515:image.png)
